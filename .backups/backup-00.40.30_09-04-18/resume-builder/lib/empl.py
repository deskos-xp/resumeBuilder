...
class emp:
    ...
    def emp_setInvalidUntilFilled(self,widget):
        ...
        widget.comboBox_2.currentIndexChanged.connect(self.validateFields)
    ...
    def emp_date_present(self,widget):
        if widget.checkBox.isChecked():
            ...
            widget.dateString.setText(widget.startDate.date().toString(self.dFormat)+" to Present")
        else:
            widget.endDate.setEnabled(True)
            widget.dateString.setText(widget.startDate.date().toString(self.dFormat)+" to "+widget.endDate.date().toString(self.dFormat))
