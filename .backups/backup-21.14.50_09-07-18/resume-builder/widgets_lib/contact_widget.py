...
class Ui_contact(object):
    def setupUi(self, contact):
        ...
        self.formLayout_2.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.street)
        ...
        self.formLayout_2.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.city)
        ...
        self.formLayout_2.setWidget(10, QtWidgets.QFormLayout.FieldRole, self.state)
        ...
        self.formLayout_2.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.zip)
        self.phoneType = QtWidgets.QComboBox(self.groupBox)
        self.phoneType.setObjectName("phoneType")
        self.formLayout_2.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.phoneType)
